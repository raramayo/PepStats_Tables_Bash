...
TYPICAL COMMANDS:
                                   $(basename ${0}) -p Homo_sapiens.GRCh38.pep.all.fa -r PepStats_Tables
...
then
    ...
    rm -fr ./${proteome}_Fasta_Gff3_Equalizer.tmp;
    func_usage;
    exit 1;
fi
## pepstats
...
if [[ $var_tmp_dir -eq 0 ]];
then
    echo -e "\tTMPDIR Requested:\tTMPDIR Run" >> ./${proteome}_${run_name}.dir/${proteome}_${run_name}.log;
else
    echo -e "\tTMPDIR Requested:\tNormal Run" >> ./${proteome}_${run_name}.dir/${proteome}_${run_name}.log;
fi
